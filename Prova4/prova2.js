		...
		objectStore.openCursor().onsuccess = function(event) {
		  ...
		  if (cursor) {
		    $('#taula > tbody:last').append("<tr><td>" + cursor.key + "</td>" +
		    									...
		    									"<td><button class='eliminar' id='" + cursor.key + "'>Eliminar</button>" +
			...
			*/
			...
			$('#taula > tbody:last').append("<tr>" +
												//"<form id='formulari'>" +
													"<td>" +
														"<input type='text' name='ssn' value='a'/>" +
													"</td>" +
													"<td>" +
														"<input type='text' name='name' value='aa'/>" +
													"</td>" +
													"<td>" +
														"<input type='text' name='age' value='aaa'/>" +
													"</td>" +
													"<td>" +
														"<input type='text' name='email' value='aaaa'/>" +
													"</td>" +
													"<td>" +
	...
	*/
	...
	function afegirRegistre(magatzem, dataJSON){
		...
		*/
		...
		//alert ("'registreAfegit' (dins la funcio): " + registreAfegit);
    ...
    //$("#afegirR").bind("click", function(){
        ...
        var info = $('#formulariAfegirDades').serializeObject();
		    ...
		    if ((cursor.key + "xxx") == idBotoEditar){
				$('#taula > tbody:last').append("<tr>" +
													//"<form id='formulari'>" +
														"<td>" + cursor.key + "</td>" +
														"<td>" +
															"<input type='text' name='name' value='" + cursor.value.name + "'/>" +
														"</td>" +
														"<td>" +
															"<input type='text' name='age' value='" + cursor.value.age + "'/>" +
														"</td>" +
														"<td>" +
															"<input type='text' name='email' value='" + cursor.value.email + "'/>" +
														"</td>" +
														"<td>" +
															"<button id='guardarR'>Guardar</button>" +
														"</td>" +
													//"</form>" +
												"</tr>");
